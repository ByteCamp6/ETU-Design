    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
        vue.createElementVNode("div", {
          class: vue.normalizeClass([vue.unref(ns).b(), vue.unref(ns).m(props.status)])
        }, [
          vue.createElementVNode("div", {
            ...
            vue.createElementVNode("div", {
              ...
              style: vue.normalizeStyle(vue.unref(progressBarOuterStyle))
            }, [
              vue.createElementVNode("div", {
                class: vue.normalizeClass(vue.unref(ns).be("bar", "inner")),
                style: vue.normalizeStyle(vue.unref(progressBarInnerStyle))
              }, [
                vue.withDirectives(vue.createElementVNode("div", {
                  class: vue.normalizeClass(vue.unref(ns).be("bar", "innerText"))
                }, [
                  vue.createElementVNode("span", null, vue.toDisplayString(props.percentage + "%"), 1)
                ], 2), [
          ...
          vue.withDirectives(vue.createElementVNode("div", {
            ...
            vue.withDirectives(vue.createElementVNode("span", null, vue.toDisplayString(props.percentage) + "%", 513), [
