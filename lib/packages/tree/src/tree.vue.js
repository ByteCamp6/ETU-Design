...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(newOptions.value, (item, index) => {
        return vue.openBlock(), vue.createElementBlock("li", {
          key: index,
          onClick: vue.withModifiers(($event) => isOpen(item), ["stop"])
        }, [
          vue.createTextVNode(vue.toDisplayString(item.label) + " ", 1),
          vue.withDirectives(vue.createVNode(_component_etu_checkbox, null, null, 512), [
            [vue.vShow, item.showCheck === true]
          ]),
          vue.createVNode(vue.Transition, { name: "slide-fade" }, {
            default: vue.withCtx(() => [
              item.children && item.children.length ? vue.withDirectives((vue.openBlock(), vue.createBlock(treeNode_vue_vue_type_script_setup_true_lang, { key: 0 }, {
                default: vue.withCtx(() => [
                  vue.createVNode(_component_etu_tree, {
