...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose, emit }) {
    ...
    const { openPopper, closePopper, doClose, doOpen } = useTimeEvent.useTimeEvent(
      props,
      manualMode,
      invalid,
      open,
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock(vue.Fragment, null, [
        vue.createElementVNode("span", {
          ...
          (...args) => vue.unref(openPopper) && vue.unref(openPopper)(...args)),
          onKeyup: _cache[1] || (_cache[1] = vue.withKeys(
            //@ts-ignore
            (...args) => vue.unref(closePopper) && vue.unref(closePopper)(...args),
            ["esc"]
          )),
          onMouseover: _cache[2] || (_cache[2] = ($event) => _ctx.hover && vue.unref(openPopper)()),
          onMouseleave: _cache[3] || (_cache[3] = ($event) => _ctx.hover && vue.unref(closePopper)())
        }, [
        ...
        (vue.openBlock(), vue.createBlock(vue.Teleport, { to: "body" }, [
          vue.createElementVNode("div", {
            ...
            onMouseover: _cache[5] || (_cache[5] = ($event) => _ctx.hover && vue.unref(openPopper)()),
            onMouseleave: _cache[6] || (_cache[6] = ($event) => _ctx.hover && vue.unref(closePopper)()),
            ref_key: "popperContainerRef",
            ref: popperContainerRef
          }, [
            vue.createVNode(vue.Transition, { name: "popper-fade" }, {
              default: vue.withCtx(() => [
                vue.withDirectives(vue.createElementVNode("div", {
                  onClick: _cache[4] || (_cache[4] = ($event) => !_ctx.interactive && vue.unref(closePopper)()),
                  class: vue.normalizeClass(vue.unref(contentCls)),
                  style: vue.normalizeStyle({ zIndex: innerZIndex.value }),
                  ref_key: "popperRef",
                  ref: popperRef
                }, [
                  ...
                  _ctx.arrow ? (vue.openBlock(), vue.createBlock(arrow_vue_vue_type_script_setup_true_lang, { key: 0 })) : vue.createCommentVNode("", true)
                ], 6), [
