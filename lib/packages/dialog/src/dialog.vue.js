    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.Teleport, { to: "body" }, [
        vue.createVNode(vue.Transition, {
          ...
          default: vue.withCtx(() => [
            vue.withDirectives(vue.createVNode(vue.unref(overlay_vue_vue_type_script_setup_true_name_EtuOverlay_lang), {
              maskEvent: "",
              ...
              default: vue.withCtx(() => [
                vue.createElementVNode("div", {
                  ...
                  vue.unref(rendered) ? (vue.openBlock(), vue.createBlock(dialogContent_vue_vue_type_script_setup_true_name_EtuDialogContent_lang, vue.mergeProps({
                    key: 0,
                  ...
                  ]), 1040, ["custom-class", "center", "align-center", "close-icon", "draggable", "show-close", "title", "onClose"])) : vue.createCommentVNode("", true)
                ], 36)
              ]),
              _: 3
            }, 8, ["z-index"]), [
