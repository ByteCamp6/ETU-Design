  ...
  setup(__props, { emit }) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("ul", {
        ...
        props.pageCount > 0 ? (vue.openBlock(), vue.createElementBlock("li", {
          key: 0,
          class: vue.normalizeClass(["number", [
        ...
        props.pageCount > 1 ? (vue.openBlock(), vue.createElementBlock("li", {
          key: 3,
          class: vue.normalizeClass([[
            vue.unref(ns).is("active", props.currentPage === props.pageCount),
            vue.unref(ns).is("disabled", props.disabled)
          ], "number"]),
          onClick: _cache[3] || (_cache[3] = ($event) => onPagerClick(props.pageCount))
        }, vue.toDisplayString(props.pageCount), 3)) : vue.createCommentVNode("", true)
      ], 2);
    };
  }
});
