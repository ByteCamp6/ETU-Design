  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createElementBlock("button", {
        ...
        props.prevText ? (vue.openBlock(), vue.createElementBlock("span", _hoisted_2, vue.toDisplayString(props.prevText), 1)) : vue.createCommentVNode("", true),
        vue.createVNode(vue.unref(icon_vue_vue_type_script_setup_true_lang), { name: "arrow-left-bold" })
      ], 8, _hoisted_1);
    };
  }
});
