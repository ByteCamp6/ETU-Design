...
const Pagination = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(props, { emit }) {
    ...
    return () => {
      ...
      const rootChildren = [];
      const TEMPLATE_MAP = {
        prev: vue.createVNode(
          prev_vue_vue_type_script_setup_true_name_EtuPaginationPrev_lang,
          {
        ...
        next: vue.createVNode(
          next_vue_vue_type_script_setup_true_name_EtuPaginationNext_lang,
          {
            disabled: props.disabled,
            currentPage: currentPageBridge.value,
        ...
        jumper: vue.createVNode(
          jumper_vue_vue_type_script_setup_true_name_EtuPaginationJumper_lang,
          null,
          null,
        ),
        pager: vue.createVNode(
          pager_vue_vue_type_script_setup_true_name_EtuPaginationPager_lang,
          {
            disabled: props.disabled,
            currentPage: currentPageBridge.value,
            pageCount: pageCountBridge.value,
        ...
        total: vue.createVNode(
          total_vue_vue_type_script_setup_true_name_EtuPaginationTotal_lang,
          {
            total: isAbsent(props.total) ? 0 : props.total,
          },
          null,
        ),
        sizes: vue.createVNode(
          sizes_vue_vue_type_script_setup_true_name_EtuPaginationSizes_lang,
          {
