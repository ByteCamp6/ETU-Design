...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { expose }) {
    ...
    const formItemContext = vue.inject("form-item");
    vue.watch(
      () => props.modelValue,
      () => {
          ...
          vue.createElementBlock(
            "div",
            {
              ...
              onMouseenter:
                ...
                (_cache[4] = //@ts-ignore
                  (...args) =>
                    vue.unref(handleMouseEnter) &&
                    vue.unref(handleMouseEnter)(...args)),
              onMouseleave:
                _cache[5] ||
                (_cache[5] = //@ts-ignore
                  (...args) =>
                    vue.unref(handleMouseLeave) &&
                    vue.unref(handleMouseLeave)(...args)),
            },
            [
                ...
                vue.mergeProps(
                  ...
                  vue.unref(attrs),
                  {
                    ...
                    onInput:
                      ...
                      (_cache[0] = //@ts-ignore
                        (...args) =>
                          vue.unref(handleInput) &&
                          vue.unref(handleInput)(...args)),
                    onChange:
                      _cache[1] ||
                      (_cache[1] = //@ts-ignore
                        (...args) =>
                          vue.unref(handleChange) &&
                          vue.unref(handleChange)(...args)),
                    onCompositionstart:
                      _cache[2] ||
                      (_cache[2] = //@ts-ignore
                        (...args) =>
                          vue.unref(handleCompositionStart) &&
                          vue.unref(handleCompositionStart)(...args)),
                    onCompositionend:
                      _cache[3] ||
                      (_cache[3] = //@ts-ignore
                        (...args) =>
                          vue.unref(handleCompositionEnd) &&
                          vue.unref(handleCompositionEnd)(...args)),
                  },
                ),
                null,
                16,
        ...
        : (vue.openBlock(),
          vue.createElementBlock(
            "div",
            {
              ...
              onMouseenter:
                _cache[11] || (_cache[11] = ($event) => (isEnter.value = true)),
              onMouseleave:
                _cache[12] ||
                (_cache[12] = ($event) => (isEnter.value = false)),
            },
            [
                    ...
                    vue.createElementBlock(
                      "div",
                      {
                        ...
                        onClick:
                          ...
                          (_cache[10] = //@ts-ignore
                            (...args) =>
                              vue.unref(clear) && vue.unref(clear)(...args)),
