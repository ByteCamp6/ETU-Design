      ...
      return vue.openBlock(), vue.createElementBlock("div", {
        ...
        vue.createElementVNode("span", {
          ...
          vue.unref(caches).size === 0 || !vue.unref(hover) ? (vue.openBlock(), vue.createBlock(_component_etu_icon, {
            key: 0,
            class: vue.normalizeClass(vue.unref(ns).e("icon-arrow")),
            name: "arrow-down-bold"
          }, null, 8, ["class"])) : (vue.openBlock(), vue.createBlock(_component_etu_icon, {
            key: 1,
            name: "error",
