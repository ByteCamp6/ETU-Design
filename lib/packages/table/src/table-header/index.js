    ...
    return () => {
      return vue.createVNode("thead", null, [vue.createVNode("tr", null, [originColumns.value.map((column, columnIndex) => {
        ...
        return vue.createVNode("th", {
          ...
          column,
          columnIndex
        }) : column.label, column.sortable && vue.createVNode("span", {
          "class": "caret-wrapper"
        }, [column.sortable.sortDirections.includes("ascend") && vue.createVNode("i", {
        ...
        }, null), column.sortable.sortDirections.includes("descend") && vue.createVNode("i", {
        ...
        }, null)]), column.filterable && vue.createVNode(filterPanel_vue_vue_type_script_setup_true_lang, {
