...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return vue.openBlock(), vue.createBlock(vue.unref(popper_vue_vue_type_script_setup_true_name_EtuPopper_lang), {
        ref_key: "PopperRef",
        ref: PopperRef,
        placement: __props.placement
      }, {
        content: vue.withCtx(() => [
          vue.createVNode(vue.unref(EtuScrollbar), { maxHeight: 280 }, {
            default: vue.withCtx(() => [
              vue.createElementVNode("div", {
                class: vue.normalizeClass(vue.unref(ns).be("filter", "content"))
              }, [
                vue.createVNode(vue.unref(EtuCheckboxGroup), {
                  modelValue: checkFilters.value,
                  "onUpdate:modelValue": _cache[0] || (_cache[0] = ($event) => checkFilters.value = $event),
                  class: vue.normalizeClass(vue.unref(ns).be("filter", "checkbox-group"))
                }, {
                  default: vue.withCtx(() => [
                    (vue.openBlock(true), vue.createElementBlock(vue.Fragment, null, vue.renderList(vue.unref(filters), (filter) => {
                      return vue.openBlock(), vue.createBlock(vue.unref(EtuCheckbox), {
                        key: filter.value,
                        label: filter.value
                      }, {
                        default: vue.withCtx(() => [
                ...
                vue.createElementVNode("div", {
                  class: vue.normalizeClass(vue.unref(ns).be("filter", "button"))
                }, [
                  vue.createElementVNode("button", { onClick: handleConfirm }, "确认"),
                  vue.createElementVNode("button", { onClick: handleReset }, "重置")
                ], 2)
              ], 2)
            ]),
            _: 1
        ...
        default: vue.withCtx(() => [
          vue.createElementVNode("span", {
            class: vue.normalizeClass(vue.unref(ns).e("column-filter-trigger"))
          }, [
            vue.createVNode(vue.unref(icon_vue_vue_type_script_setup_true_lang), { name: "arrow-down-bold" })
          ], 2)
        ]),
        _: 1
      }, 8, ["placement"]);
