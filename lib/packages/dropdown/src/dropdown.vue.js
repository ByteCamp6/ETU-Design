...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props) {
    ...
    const { handleMousedown, onButtonClick } = useDropdownEvent.useDropdownEvent();
    ...
    return (_ctx, _cache) => {
      ...
      return vue.openBlock(), vue.createElementBlock("span", {
        ...
        vue.createElementVNode("span", _hoisted_1, [
          _ctx.splitButton ? (vue.openBlock(), vue.createElementBlock("button", {
            key: 0,
            style: { "border-radius": "5px 0 0 5px" },
            class: vue.normalizeClass(_ctx.splitButton ? bgCls : []),
            onClick: _cache[0] || (_cache[0] = //@ts-ignore
            (...args) => vue.unref(onButtonClick) && vue.unref(onButtonClick)(...args))
          }, [
            vue.renderSlot(_ctx.$slots, "default")
          ], 2)) : vue.createCommentVNode("", true),
          vue.createVNode(vue.unref(popper_vue_vue_type_script_setup_true_name_EtuPopper_lang), {
            arrow: "",
            ...
            default: vue.withCtx(() => [
              _ctx.splitButton ? (vue.openBlock(), vue.createElementBlock("button", {
                ...
                _ctx.splitButton ? (vue.openBlock(), vue.createBlock(_component_etu_icon, {
                  key: 0,
                  name: "arrow-down-bold"
                })) : vue.createCommentVNode("", true)
              ], 2)) : (vue.openBlock(), vue.createElementBlock("span", _hoisted_2, [
                vue.renderSlot(_ctx.$slots, "default"),
                vue.unref(isUseArrowDown) ? (vue.openBlock(), vue.createBlock(_component_etu_icon, {
                  key: 0,
                  name: "arrow-down-bold"
                })) : vue.createCommentVNode("", true)
              ]))
