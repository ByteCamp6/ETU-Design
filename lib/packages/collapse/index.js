...
collapse_vue_vue_type_script_setup_true_lang.install = (app) => {
  app.component(
    collapse_vue_vue_type_script_setup_true_lang.name,
    collapse_vue_vue_type_script_setup_true_lang,
  );
};
collapseItem_vue_vue_type_script_setup_true_lang.install = (app) => {
  app.component(
    collapseItem_vue_vue_type_script_setup_true_lang.name,
    collapseItem_vue_vue_type_script_setup_true_lang,
  );
};
const collapse = {
