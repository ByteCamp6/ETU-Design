                ...
                _component_etu_icon,
                {
                  ...
                  onClick:
                    ...
                    (_cache[0] = vue.withModifiers(
                      ($event) => handleClickYear("subtract"),
                      ["stop"],
                    )),
                },
                null,
            ...
            vue.withDirectives(
                ...
                _component_etu_icon,
                {
                  ...
                  onClick:
                    ...
                    (_cache[1] = vue.withModifiers(
                      ($event) => vue.unref(monthSubtract)(_ctx.index),
                      ["stop"],
                    )),
                },
                null,
              ...
              [
                [
                  vue.vShow,
                  vue.unref(type) === "date" ||
                    (vue.unref(type) === "daterange" && _ctx.left),
                ],
              ],
            ),
                    ...
                    vue.createElementBlock(
                      ...
                      [
                        vue.createElementVNode(
                          ...
                          vue.toDisplayString(vue.unref(yearRange)),
                          3,
                        ),
                      ],
                      2,
                    ))
                  : vue.unref(type) === "month"
                  ? (vue.openBlock(),
                    vue.createElementBlock(
                      "div",
                      {
                          ...
                          "span",
                          {
                            ...
                            onClick:
                              ...
                              (_cache[2] = vue.withModifiers(
                                ($event) => handleClickType("year"),
                                ["stop"],
                              )),
                          },
                          vue.toDisplayString(vue.unref(value).year()),
                          3,
                        ),
                      ],
                      2,
                          ...
                          "span",
                          {
                            ...
                            onClick:
                              ...
                              (_cache[4] = vue.withModifiers(
                                ($event) => handleClickType("month"),
                                ["stop"],
                              )),
                          },
                          vue.toDisplayString(
                            vue.unref(utils.getMonthEn)(
                              vue.unref(value).month(),
                            ),
                          ),
                          3,
                        ),
            ...
            vue.withDirectives(
                ...
                _component_etu_icon,
                {
                  ...
                  onClick:
                    ...
                    (_cache[5] = vue.withModifiers(
                      ($event) => vue.unref(monthAdd)(_ctx.index),
                      ["stop"],
                    )),
                },
                null,
              ...
              [
                [
                  vue.vShow,
                  vue.unref(type) === "date" ||
                    (vue.unref(type) === "daterange" && _ctx.right),
                ],
              ],
            ),
            vue.withDirectives(
