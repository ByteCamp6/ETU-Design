...
const _sfc_main = /* @__PURE__ */ vue.defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const component = vue.shallowRef(
      dateTable_vue_vue_type_script_setup_true_lang,
    );
    vue.provide(
                    ...
                    vue.createBlock(
                      _component_etu_input,
                      {
                        ...
                        "onUpdate:modelValue":
                          _cache[0] ||
                          (_cache[0] = ($event) =>
                            vue.isRef(currentLabel)
                              ? (currentLabel.value = $event)
                              : null),
                      },
                      null,
                      8,
                        ...
                        vue.createElementVNode(
                          "input",
                          {
                            ...
                            "onUpdate:modelValue":
                              _cache[1] ||
                              (_cache[1] = ($event) =>
                                vue.isRef(startLabel)
                                  ? (startLabel.value = $event)
                                  : null),
                          },
                          null,
                          2,
                        ...
                        vue.createElementBlock(
                          "div",
                          {
                            ...
                            class: vue.normalizeClass(
                              vue.unref(ns).e("dropdown"),
                            ),
                          },
                          [
                            vue.createVNode(
                              dateNav_vue_vue_type_script_setup_true_lang,
                              {
                    ...
                    : vue.withDirectives(
                        ...
                        vue.createElementBlock(
                          "div",
                          {
                            ...
                            class: vue.normalizeClass([
                              vue.unref(ns).e("dropdown"),
                              vue.unref(ns).em("dropdown", "range"),
                            ]),
                          },
                          [
                            vue.createElementVNode(
