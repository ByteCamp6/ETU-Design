    ...
    return (_ctx, _cache) => {
      return (
        ...
        vue.createElementBlock("div", null, [
          !vue.unref(isPictureCard) ||
          (vue.unref(isPictureCard) && !props.showFileList)
            ? (vue.openBlock(),
              vue.createBlock(
                uploadContent_vue_vue_type_script_setup_true_name_EtuUploadContent_lang,
                vue.mergeProps(
                  {
                    key: 0,
                    ref_key: "uploadRef",
                ...
                {
                  default: vue.withCtx(() => [
                    vue.unref(slots).trigger
                      ? vue.renderSlot(_ctx.$slots, "trigger", { key: 0 })
                      : vue.createCommentVNode("", true),
                    !vue.unref(slots).trigger && vue.unref(slots).default
          ...
          !vue.unref(isPictureCard) && props.showFileList
            ? (vue.openBlock(),
              vue.createBlock(
                uploadList_vue_vue_type_script_setup_true_name_EtuUploadList_lang,
                {
                  key: 2,
