              ...
              },
              {
                default: vue.withCtx(() => [
                  ...
                  vue.createElementBlock(
                    vue.Fragment,
                    null,
                    vue.renderList(props.files, (file) => {
                      return (
                        vue.openBlock(),
                        vue.createElementBlock(
                          "li",
                          {
                            ...
                            class: vue.normalizeClass([
                              vue.unref(ns).be("list", "item"),
                              vue.unref(ns).is(file.status),
                            ]),
                          },
                          [
                            vue.renderSlot(
                              ...
                              () => [
                                vue.createElementVNode(
                                  ...
                                  {
                                    class: vue.normalizeClass(
                                      vue.unref(ns).be("list", "item-info"),
                                    ),
                                  },
                                  [
                                    vue.createElementVNode(
                                      ...
                                      {
                                        class: vue.normalizeClass(
                                          vue.unref(ns).be("list", "item-name"),
                                        ),
                                        onClick: vue.withModifiers(
                                          ($event) => props.handlePreview(file),
                                          ["prevent"],
                                        ),
                                      },
                                      [
