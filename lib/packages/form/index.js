...
form_vue_vue_type_script_setup_true_lang.install = (app) => {
  app.component(form_vue_vue_type_script_setup_true_lang.name, form_vue_vue_type_script_setup_true_lang);
};
formItem_vue_vue_type_script_setup_true_lang.install = (app) => {
  app.component(formItem_vue_vue_type_script_setup_true_lang.name, formItem_vue_vue_type_script_setup_true_lang);
};
