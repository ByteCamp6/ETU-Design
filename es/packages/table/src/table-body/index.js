...
const TableBody = /* @__PURE__ */ defineComponent({
  ...
  setup() {
    ...
    return () => {
      return createVNode("tbody", null, [data.value.map((rowData, rowIndex) => {
        return createVNode("tr", {
          ...
          return createVNode("td", {
            "key": columnIndex,
            "class": combineClass([ns.e("cell"), ns.is(column.align), ns.bm("fixed-column", column.fixed), ns.is("last-column", column.stylePosition === "last"), ns.is("first-column", column.stylePosition === "first")], column == null ? void 0 : column.bodyCellClass, {
