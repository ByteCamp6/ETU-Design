import { defineComponent, ref, computed, onMounted, nextTick, onUpdated, openBlock, createElementBlock, normalizeClass, unref, createElementVNode, normalizeStyle, renderSlot, createBlock, createCommentVNode } from "vue";
...
const _sfc_main = /* @__PURE__ */ defineComponent({
  ...
  setup(__props, { emit }) {
    ...
    const update = () => {
      if (!wrap.value || (props == null ? void 0 : props.native))
        return;
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("div", {
        ...
        !_ctx.native ? (openBlock(), createBlock(_sfc_main$1, {
          ...
          ref_key: "barRef",
          ref: barRef
        }, null, 8, ["always", "width", "height", "ratioX", "ratioY"])) : createCommentVNode("", true)
      ], 2);
    };
  }
});
