            ...
            createElementVNode(
              "span",
              {
                ...
                onFocus:
                  ...
                  (_cache[0] = //@ts-ignore
                    (...args) =>
                      unref(openPopper) && unref(openPopper)(...args)),
                onKeyup:
                  _cache[1] ||
                  (_cache[1] = withKeys(
                    //@ts-ignore
                    (...args) =>
                      unref(closePopper) && unref(closePopper)(...args),
                    ["esc"],
                  )),
                onMouseover:
                  _cache[2] ||
                  (_cache[2] = ($event) => _ctx.hover && unref(openPopper)()),
                onMouseleave:
                  _cache[3] ||
                  (_cache[3] = ($event) => _ctx.hover && unref(closePopper)()),
              },
            ...
            createBlock(Teleport, { to: "body" }, [
              createElementVNode(
                "div",
                {
                  ...
                  onMouseover:
                    _cache[5] ||
                    (_cache[5] = ($event) => _ctx.hover && unref(openPopper)()),
                  onMouseleave:
                    _cache[6] ||
                    (_cache[6] = ($event) =>
                      _ctx.hover && unref(closePopper)()),
                          ...
                          createElementVNode(
                            "div",
                            {
                              onClick:
                                _cache[4] ||
                                (_cache[4] = ($event) =>
                                  !_ctx.interactive && unref(closePopper)()),
