          ...
          createElementBlock(
            "div",
            {
              ...
              onMouseenter:
                ...
                (_cache[4] = //@ts-ignore
                  (...args) =>
                    unref(handleMouseEnter) &&
                    unref(handleMouseEnter)(...args)),
              onMouseleave:
                _cache[5] ||
                (_cache[5] = //@ts-ignore
                  (...args) =>
                    unref(handleMouseLeave) &&
                    unref(handleMouseLeave)(...args)),
            },
            [
              createElementVNode(
                "textarea",
                mergeProps(
                  ...
                  unref(attrs),
                  {
                    ...
                    onInput:
                      ...
                      (_cache[0] = //@ts-ignore
                        (...args) =>
                          unref(handleInput) && unref(handleInput)(...args)),
                    onChange:
                      _cache[1] ||
                      (_cache[1] = //@ts-ignore
                        (...args) =>
                          unref(handleChange) && unref(handleChange)(...args)),
                    onCompositionstart:
                      _cache[2] ||
                      (_cache[2] = //@ts-ignore
                        (...args) =>
                          unref(handleCompositionStart) &&
                          unref(handleCompositionStart)(...args)),
                    onCompositionend:
                      _cache[3] ||
                      (_cache[3] = //@ts-ignore
                        (...args) =>
                          unref(handleCompositionEnd) &&
                          unref(handleCompositionEnd)(...args)),
                  },
                ),
                null,
                16,
