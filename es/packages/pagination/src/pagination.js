import { defineComponent, getCurrentInstance, computed, ref, watch, provide, createVNode } from "vue";
...
const Pagination = /* @__PURE__ */ defineComponent({
  ...
  setup(props, {
    ...
    return () => {
      ...
      const rootChildren = [];
      const TEMPLATE_MAP = {
        prev: createVNode(_sfc_main, {
          "disabled": props.disabled,
          "currentPage": currentPageBridge.value,
          "prevText": props.prevText,
          "onClick": prev
        }, null),
        next: createVNode(_sfc_main$1, {
          "disabled": props.disabled,
          "currentPage": currentPageBridge.value,
        ...
        total: createVNode(_sfc_main$4, {
          "total": isAbsent(props.total) ? 0 : props.total
        }, null),
        sizes: createVNode(_sfc_main$5, {
