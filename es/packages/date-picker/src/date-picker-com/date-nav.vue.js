            ...
            withDirectives(
                ...
                _component_etu_icon,
                {
                  ...
                  onClick:
                    ...
                    (_cache[1] = withModifiers(
                      ($event) => unref(monthSubtract)(_ctx.index),
                      ["stop"],
                    )),
                },
                null,
              ...
              [
                [
                  vShow,
                  unref(type) === "date" ||
                    (unref(type) === "daterange" && _ctx.left),
                ],
              ],
            ),
            createElementVNode(
                    ...
                    createElementBlock(
                      ...
                      [
                        createElementVNode(
                          ...
                          toDisplayString(unref(yearRange)),
                          3,
                        ),
                      ],
                      2,
                    ...
                    createElementBlock(
                      ...
                      [
                        createElementVNode(
                          ...
                          toDisplayString(unref(value).year()),
                          3,
                        ),
                      ],
                      2,
                    ...
                    createElementBlock(
                      ...
                      [
                        ...
                        createElementVNode(
                          ...
                          toDisplayString(
                            unref(getMonthEn)(unref(value).month()),
                          ),
                          3,
                        ),
                      ],
            ...
            withDirectives(
                ...
                _component_etu_icon,
                {
                  ...
                  onClick:
                    ...
                    (_cache[5] = withModifiers(
                      ($event) => unref(monthAdd)(_ctx.index),
                      ["stop"],
                    )),
                },
                null,
              ...
              [
                [
                  vShow,
                  unref(type) === "date" ||
                    (unref(type) === "daterange" && _ctx.right),
                ],
              ],
            ),
            withDirectives(
