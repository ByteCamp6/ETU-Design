import { defineComponent, inject, toRefs, ref, watch, onMounted, openBlock, createElementBlock, normalizeClass, unref, createElementVNode, Fragment, renderList, toDisplayString, withModifiers } from "vue";
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("table", {
        ...
        createElementVNode("tr", null, [
          (openBlock(true), createElementBlock(Fragment, null, renderList(unref(WEEKSSHORT), (item) => {
            return openBlock(), createElementBlock("th", { key: item }, toDisplayString(item), 1);
          }), 128))
        ]),
        (openBlock(true), createElementBlock(Fragment, null, renderList(unref(tableData), (row) => {
