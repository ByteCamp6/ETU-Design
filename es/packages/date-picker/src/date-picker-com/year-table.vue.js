import { defineComponent, inject, toRefs, reactive, watch, onMounted, openBlock, createElementBlock, normalizeClass, unref, Fragment, renderList, withModifiers, createElementVNode, toDisplayString } from "vue";
  ...
  setup(__props) {
    ...
    return (_ctx, _cache) => {
      return openBlock(), createElementBlock("table", {
        ...
        (openBlock(true), createElementBlock(Fragment, null, renderList(years, (row) => {
